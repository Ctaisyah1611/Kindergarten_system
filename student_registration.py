...
def calculate_age(*args):
    try:
        ...
        current_year = int(current_year.get())
...
def submit_registration():
    try:
        ...
        birth_year = int(spinbox_birth_year.get())
...
label = tk.Label(root, text="Student Registration", font=("Arial", 15, "bold"))
label.grid(row=0, column=0, columnspan=3,pady=(20, 20))  
